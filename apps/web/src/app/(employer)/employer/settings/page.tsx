...
function DocumentsSection() {
  return (
    <div className="card p-6 max-w-2xl">
      ...
      <div
        className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50/50 p-10 text-center transition hover:border-brand/40 hover:bg-brand/3 cursor-pointer"
